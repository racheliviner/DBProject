...
insert into TICKETSALES (TICKETID, PRICE, ISSOLD, SCHEDULEID, SUBSCRIBERID) values (111, 129.54, 'N', 483, 320);
insert into TICKETSALES (TICKETID, PRICE, ISSOLD, SCHEDULEID, SUBSCRIBERID) values (112, 60.67, 'N', 397, 305);
insert into TICKETSALES (TICKETID, PRICE, ISSOLD, SCHEDULEID, SUBSCRIBERID) values (113, 113.97, 'N', 396, 354);
insert into TICKETSALES (TICKETID, PRICE, ISSOLD, SCHEDULEID, SUBSCRIBERID) values (114, 66.99, 'N', 371, 193);
insert into TICKETSALES (TICKETID, PRICE, ISSOLD, SCHEDULEID, SUBSCRIBERID) values (115, 73.21, 'N', 481, 331);
insert into TICKETSALES (TICKETID, PRICE, ISSOLD, SCHEDULEID, SUBSCRIBERID) values (116, 142.44, 'N', 240, 244);
insert into TICKETSALES (TICKETID, PRICE, ISSOLD, SCHEDULEID, SUBSCRIBERID) values (117, 139.58, 'N', 366, 386);
insert into TICKETSALES (TICKETID, PRICE, ISSOLD, SCHEDULEID, SUBSCRIBERID) values (118, 103.84, 'N', 489, 120);
